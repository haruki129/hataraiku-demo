...
function renderApproval(c,sub,act) {
  ...
  c.innerHTML='<div style="display:flex;gap:8px;margin-bottom:20px;">'+['å¨ã¦','ç³è«ä¸­','æ¿èª','å·®æ»ã'].map(function(f,i){var a=i===0;return '<button style="padding:6px 16px;border-radius:20px;font-size:12px;cursor:pointer;border:1px solid '+(a?'#5B4FE8':'#e0e0e0')+';background:'+(a?'#5B4FE8':'#fff')+';color:'+(a?'#fff':'#888')+';">'+f+'</button>';}).join('')+'</div>';
